...
export default function LandingPageAgendamento() {
  return (
    <>
      <main className="landing-container">
        <section className="hero-section">
          <p className="subheadline">
            Conectamos pessoas a empresas especializadas no descarte consciente
            de lixo eletrônico.
          </p>
        ...
        <section className="info-section">
          ...
          <p>
            ...
            baterias e carregadores. Muitos desses materiais contêm metais
            pesados e substâncias tóxicas que podem prejudicar o meio ambiente e
            a saúde se descartados de forma inadequada.
          </p>
        </section>
        ...
        <section className="solution-section">
          ...
          <p>
            Somos a ponte entre você e empresas licenciadas para o recolhimento
            e tratamento do lixo eletrônico. Agende seu descarte com poucos
            cliques, de forma segura, gratuita e responsável.
          </p>
        </section>
        ...
        <section className="call-to-action">
          ...
          <p>
            Cadastre-se agora e agende seu primeiro descarte com empresas
            confiáveis da sua região.
          </p>
          <button
